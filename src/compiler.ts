...
export type CompilerOptions = {
   ...
   *
   * @see https://github.com/maranomynet/es-in-css/tree/v0.5#compilation-api
   */
  outdir?: string;
 ...
 *
 * @see https://github.com/maranomynet/es-in-css/tree/v0.5#compilecss-from-files
 */
 ...
 *
 * @see https://github.com/maranomynet/es-in-css/tree/v0.5#compilecssfromjs
 */
 ...
 *
 * @see https://github.com/maranomynet/es-in-css/tree/v0.5#compilecssstring
 */
